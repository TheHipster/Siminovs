...
SWEP.PrintName			= "H&K XM8"					// 'Nice' Weapon name (Shown on HUD)	
...
if (file.Exists("materials/weapons/weapon_ins_sim_xm8.vmt","GAME")) then
	SWEP.WepSelectIcon	= surface.GetTextureID("weapons/weapon_ins_sim_xm8")
end
