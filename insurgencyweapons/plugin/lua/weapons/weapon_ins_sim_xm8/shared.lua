...
SWEP.ViewModel			= Model("models/weapons/i_rif_xc.mdl")
SWEP.WorldModel			= Model("models/weapons/j_rif_xc.mdl")
SWEP.ViewModelFOV      = 60
SWEP.Spawnable			= false
SWEP.AdminSpawnable		= false

SWEP.Primary.Sound 		= Sound("Weapoi_XM.Single")
...
function SWEP:Reload()
	...
	if (self.Owner:KeyDown(IN_USE)) then
		...
		if (SERVER) then
			...
			local knife = ents.Create("weapon_ins_sim_ent_xm8")
...
//			end
			...
			self.Owner:StripWeapon("weapon_ins_sim_xm8")
			if (SERVER) then
