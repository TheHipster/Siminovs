...
SWEP.ViewModel			= Model("models/weapons/i_rif_hk534u.mdl")
SWEP.WorldModel			= Model("models/weapons/j_rif_hk534u.mdl")
SWEP.ViewModelFOV      = 65
SWEP.Spawnable			= false
SWEP.AdminSpawnable		= false

SWEP.Primary.Sound 		= Sound("Weapoi_hk53.Single")
SWEP.Primary.Recoil		= 1.5
SWEP.Primary.Damage		= 20
SWEP.Primary.NumShots		= 1
SWEP.Primary.Cone			= 0.0085
SWEP.Primary.Delay 		= 0.0857142857142857
...
SWEP.IronSightsPos = Vector (-1.9817, -3.0003, 1.0233)
SWEP.IronSightsAng = Vector (0.0666, 0.0071, 0)
...
function SWEP:Reload()
	...
	if (self.Owner:KeyDown(IN_USE)) then
		...
		if (SERVER) then
			...
			local knife = ents.Create("weapon_ins_sim_ent_hk53")
...
//			end
			...
			self.Owner:StripWeapon("weapon_ins_sim_hk53")
			if (SERVER) then
