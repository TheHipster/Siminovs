...
SWEP.ViewModel			= Model("models/weapons/i_rif_ha.mdl")
SWEP.WorldModel			= Model("models/weapons/j_rif_ha.mdl")
...
function SWEP:Reload()
	...
	if (self.Owner:KeyDown(IN_USE)) then
		...
		if (SERVER) then
			...
			local knife = ents.Create("weapon_ins_sim_ent_hk416s")
...
//			end
			...
			self.Owner:StripWeapon("weapon_ins_sim_hk416s")
			if (SERVER) then
