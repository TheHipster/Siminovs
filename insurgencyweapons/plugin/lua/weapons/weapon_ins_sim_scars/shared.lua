...
SWEP.ViewModel			= Model("models/weapons/i_rif_sc.mdl")
SWEP.WorldModel			= Model("models/weapons/j_rif_sc.mdl")
...
function SWEP:Reload()
	...
	if (self.Owner:KeyDown(IN_USE)) then
		...
		if (SERVER) then
			...
			local knife = ents.Create("weapon_ins_sim_ent_scars")
...
//			end
			...
			self.Owner:StripWeapon("weapon_ins_sim_scars")
			if (SERVER) then
