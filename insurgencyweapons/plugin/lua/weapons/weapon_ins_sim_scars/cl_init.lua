...
SWEP.PrintName			= "FN SCAR-L W/ ACOG"					// 'Nice' Weapon name (Shown on HUD)	
...
if (file.Exists("materials/weapons/weapon_ins_sim_scars.vmt","GAME")) then
	SWEP.WepSelectIcon	= surface.GetTextureID("weapons/weapon_ins_sim_scars")
end
