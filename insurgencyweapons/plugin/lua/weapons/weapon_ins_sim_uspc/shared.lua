...
SWEP.ViewModel			= Model("models/weapons/i_pist_mm.mdl")
SWEP.WorldModel			= Model("models/weapons/j_pist_mc.mdl")
...
function SWEP:Reload()
	...
	if (self.Owner:KeyDown(IN_USE)) then
		...
		if (SERVER) then
			...
			local knife = ents.Create("weapon_ins_sim_ent_uspc")
...
//			end
			...
			self.Owner:StripWeapon("weapon_ins_sim_uspc")
			if (SERVER) then
