...
SWEP.ViewModel			= Model("models/weapons/i_rif_g36sd.mdl")
SWEP.WorldModel			= Model("models/weapons/j_rif_g36sd.mdl")
SWEP.ViewModelFOV      = 65
SWEP.Spawnable			= false
SWEP.AdminSpawnable		= false

SWEP.Primary.Sound 		= Sound("Weapoi_G36c.Single")
...
function SWEP:Reload()
	...
	if (self.Owner:KeyDown(IN_USE)) then
		...
		if (SERVER) then
			...
			local knife = ents.Create("weapon_ins_sim_ent_g36cs")
...
//			end
			...
			self.Owner:StripWeapon("weapon_ins_sim_g36cs")
			if (SERVER) then
