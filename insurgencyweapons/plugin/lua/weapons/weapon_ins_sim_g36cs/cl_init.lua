...
SWEP.PrintName			= "H&K G36C W/ACOG"					// 'Nice' Weapon name (Shown on HUD)	
...
if (file.Exists("materials/weapons/weapon_ins_sim_g36cs.vmt","GAME")) then
	SWEP.WepSelectIcon	= surface.GetTextureID("weapons/weapon_ins_sim_g36cs")
end
