...
SWEP.ViewModel			= Model("models/weapons/i_rif_hm.mdl")
SWEP.WorldModel			= Model("models/weapons/j_rif_hm.mdl")
...
SWEP.IronSightsPos = Vector (-2.024, -4.0006, 0.9702)
SWEP.IronSightsAng = Vector (0.0732, 0.0086, 0)
...
function SWEP:Reload()
	...
	if (self.Owner:KeyDown(IN_USE)) then
		...
		if (SERVER) then
			...
			local knife = ents.Create("weapon_ins_sim_ent_hk416m")
...
//			end
			...
			self.Owner:StripWeapon("weapon_ins_sim_hk416m")
			if (SERVER) then
