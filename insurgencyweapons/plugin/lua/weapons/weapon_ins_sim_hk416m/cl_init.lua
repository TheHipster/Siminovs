...
SWEP.PrintName			= "H&K HK416 W/ Magnified EOTECH"					// 'Nice' Weapon name (Shown on HUD)	
...
if (file.Exists("materials/weapons/weapon_ins_sim_hk416m.vmt","GAME")) then
	SWEP.WepSelectIcon	= surface.GetTextureID("weapons/weapon_ins_sim_hk416m")
end
	...
	if (self.Sniper) then
		...
		if (bScope) then 
			...
			if (self.RedDot) then
				...
				surface.SetTexture(surface.GetTextureID("scope/crosshair_eotech"))
			end
