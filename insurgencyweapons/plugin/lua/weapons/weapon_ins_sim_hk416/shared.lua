...
SWEP.ViewModel			= Model("models/weapons/i_rif_hk4ed.mdl")
SWEP.WorldModel			= Model("models/weapons/j_rif_hk4ed.mdl")
...
SWEP.IronSightsPos = Vector (-2.0277, -3.0003, 0.9613)
SWEP.IronSightsAng = Vector (0.0142, 0.0335, 0)
...
function SWEP:Reload()
	...
	if (self.Owner:KeyDown(IN_USE)) then
		...
		if (SERVER) then
			...
			local knife = ents.Create("weapon_ins_sim_ent_hk416")
...
//			end
			...
			self.Owner:StripWeapon("weapon_ins_sim_hk416")
			if (SERVER) then
