...
SWEP.ViewModel			= Model("models/weapons/i_rif_g36ed.mdl")
SWEP.WorldModel			= Model("models/weapons/j_rif_g36ed.mdl")
...
function SWEP:Reload()
	...
	if (self.Owner:KeyDown(IN_USE)) then
		...
		if (SERVER) then
			...
			local knife = ents.Create("weapon_ins_sim_ent_g36c")
...
//			end
			...
			self.Owner:StripWeapon("weapon_ins_sim_g36c")
			if (SERVER) then
