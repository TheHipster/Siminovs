...
SWEP.ViewModel			= Model("models/weapons/i_pist_sg.mdl")
SWEP.WorldModel			= Model("models/weapons/j_pist_sg.mdl")

SWEP.Primary.Sound			= Sound("Weapoi_SIG.Single")
...
function SWEP:Reload()
	...
	if (self.Owner:KeyDown(IN_USE)) then
		...
		if (SERVER) then
			...
			local knife = ents.Create("weapon_ins_sim_ent_sig226")
...
//			end
			...
			self.Owner:StripWeapon("weapon_ins_sim_sig226")
			if (SERVER) then
