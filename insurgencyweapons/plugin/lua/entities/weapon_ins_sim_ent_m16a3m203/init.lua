...
function ENT:SpawnFunction(ply, tr)
	...
	local ent = ents.Create("weapon_ins_sim_ent_m16a3m203")
		ent:SetPos(SpawnPos)
	ent:Spawn()
	ent:Activate()
...
function ENT:Initialize()
	...
	self.Entity:SetModel("models/weapons/j_rif_m16m202.mdl")
...
function ENT:Use(ply)
	if ply:IsPlayer() and (not ply:HasWeapon("weapon_ins_sim_m16a3m203") and not ply:HasWeapon("weapon_ins_sim_m203a3")) then
		self.Entity:EmitSound("BaseCombatCharacter.AmmoPickup")
		ply:Give("weapon_ins_sim_m16a3m203")
		ply:Give("weapon_ins_sim_m203a3")
		self:Remove()
	end
end
