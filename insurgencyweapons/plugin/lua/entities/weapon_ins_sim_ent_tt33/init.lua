...
function ENT:SpawnFunction(ply, tr)
	...
	local ent = ents.Create("weapon_ins_sim_ent_tt33")
		ent:SetPos(SpawnPos)
	ent:Spawn()
	ent:Activate()
...
function ENT:Initialize()
	...
	self.Entity:SetModel("models/weapons/j_pist_takarov.mdl")
...
function ENT:Use(ply)
	if ply:IsPlayer() and not ply:HasWeapon("weapon_ins_sim_tt33") then
		self.Entity:EmitSound("BaseCombatCharacter.AmmoPickup")
		ply:Give("weapon_ins_sim_tt33")
		self:Remove()
	end
end
