...
function ENT:SpawnFunction(ply, tr)
	...
	local ent = ents.Create("weapon_ins_sim_ent_g36c")
		ent:SetPos(SpawnPos)
	ent:Spawn()
	ent:Activate()
...
function ENT:Initialize()
	...
	self.Entity:SetModel("models/weapons/j_rif_g36ed.mdl")
...
function ENT:Use(ply)
	if ply:IsPlayer() and not ply:HasWeapon("weapon_ins_sim_g36c") then
		self.Entity:EmitSound("BaseCombatCharacter.AmmoPickup")
		ply:Give("weapon_ins_sim_g36c")
		self:Remove()
	end
end
